import 'package:account_book_app/page/app_menu_select.dart';
import 'package:account_book_app/page/expense/expense_add_or_edit_page.dart';
import 'package:account_book_app/page/user/login_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        var routes = {
          "/appMenu": const AppMenuSelect(),
          "/signUp": const SignUpPage(),
          "/socialLogin": SignUpPage(email: params["email"] ?? "", name: params["name"] ?? "", isSocialLogin: true,),
          "/login": const LoginPage(),
          "/profile": ProfilePage(profileUrl : params['profileUrl'] ?? "", tel: params['tel'] ?? "", name: params['name'] ?? ""),
          "/expenseAdd": const ExpenseAddOrEditPage(),
          "/expenseEdit": ExpenseAddOrEditPage(isEditing: true, expenseId: params['expenseId'] ?? 0,)
        };

        var getMoveRouters = settings.name;
